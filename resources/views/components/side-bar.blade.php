<div class="d-flex flex-column sidebar pt-4">
    ...
    @can('admin')
        <a href="{{ route('collaborators') }}"><i class="fas fa-users me-3"></i>Collaborators</a>
        <a href="{{ route('rh.collaborators') }}"><i class="fas fa-user-gear me-3"></i>RH Collaborators</a>
